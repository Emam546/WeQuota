...
export default function UserInfo({ customerData }: UserInfoProps) {
  const { individualInfo, certificationInfo, contactPersonList, addressInfoList, custId, custCode } =
    customerData.body
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            ...
            <p className="text-blue-100 text-[10px] sm:text-xs">Personal details and contact info</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-2 sm:space-y-3">
              {contactPersonList.map((contact, index) => (
                <div key={index} className="bg-slate-50 rounded-lg p-3 sm:p-4">
                  ...
                  <div className="text-xs sm:text-sm font-semibold text-slate-800">{contact.officePhone}</div>
                </div>
              ))}
            </div>
          </motion.div>
            ...
            <div className="space-y-2 sm:space-y-3">
              {addressInfoList.map((address, index) => (
                <div key={index} className="bg-slate-50 rounded-lg p-3 sm:p-4">
                  ...
                  <div className="text-xs sm:text-sm font-semibold text-slate-800">{address.addr4}</div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-slate-50 rounded-lg p-3 sm:p-4">
                ...
                <div className="text-xs sm:text-sm font-semibold text-slate-800">{certificationInfo.certficateId}</div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-3 sm:p-4">
                ...
                <div className="text-xs sm:text-sm font-semibold text-slate-800">{certificationInfo.certId}</div>
              </div>
            </div>
          </motion.div>
        </div>
