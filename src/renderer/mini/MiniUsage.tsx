...
import { HardDrive, Wallet, TrendingUp, Maximize2, X } from 'lucide-react'
...
export default function MiniUsage({ data, onOpenMain, onClose }: MiniUsageProps) {
  const { quota, balance } = data
