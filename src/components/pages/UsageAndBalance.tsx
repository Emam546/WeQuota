...
export default function UsageAndBalance({
  ...
  return (
    <div className="w-full space-y-4 font-sans sm:space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 sm:gap-6">
        ...
        >
          <div className="px-4 py-3 bg-linear-to-r from-blue-600 to-blue-700 sm:px-6 sm:py-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm">
                <HardDrive size={16} className="text-white sm:size-20" />
              </div>
              <div>
                <h2 className="text-sm font-bold text-white sm:text-lg">{quota.offerName}</h2>
          ...
          <div className="p-4 sm:p-6">
              ...
              <div className="relative">
                ...
                >
                  <div className="flex flex-col items-center">
                    <span className="text-xl font-bold tracking-tighter text-blue-600 sm:text-2xl">
            ...
            <div className="grid grid-cols-3 gap-2 mb-4 sm:gap-4 sm:mb-6">
              <div className="text-center">
                ...
                <div className="text-sm font-bold sm:text-lg text-slate-800">{quota.total} GB</div>
              </div>
              <div className="text-center">
                <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-slate-400 font-bold mb-1">
                  Used
            ...
            <div className="p-3 rounded-lg bg-slate-50 sm:p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Clock size={14} className="text-blue-600 sm:size-16" />
        ...
        <motion.div
          ...
          className="bg-white rounded-lg shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-200"
        >
          <div className="px-4 py-3 bg-linear-to-r from-green-600 to-green-700 sm:px-6 sm:py-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="flex items-center justify-center w-8 h-8 rounded-lg sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm">
                <Wallet size={16} className="text-white sm:size-20" />
              </div>
              <div>
                <h2 className="text-sm font-bold text-white sm:text-lg">Account Balance</h2>
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-200"
      >
        <div className="px-4 py-3 bg-linear-to-r from-purple-600 to-purple-700 sm:px-6 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm">
              <PieChart size={16} className="text-white sm:size-20" />
            </div>
            <div>
              <h2 className="text-sm font-bold text-white sm:text-lg">Usage Breakdown</h2>
        ...
        <div className="p-4 sm:p-6">
          <div className="mb-3 sm:mb-4">
            ...
            <div className="text-xs font-semibold sm:text-sm text-slate-800">
              {formatDate(last7Days.consumptionStartDate)} -{' '}
              {formatDate(last7Days.consumptionEndDate)}
            </div>
          </div>
      ...
      <motion.div
        ...
        className="bg-white rounded-lg shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] overflow-hidden border border-slate-200"
      >
        <div className="px-4 py-3 bg-linear-to-r from-orange-600 to-orange-700 sm:px-6 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="flex items-center justify-center w-8 h-8 rounded-lg sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm">
              <TrendingUp size={16} className="text-white sm:size-20" />
            </div>
            <div>
              <h2 className="text-sm font-bold text-white sm:text-lg">Last Cycle</h2>
        ...
        <div className="p-4 sm:p-6">
          <div className="mb-3 sm:mb-4">
            ...
            <div className="text-xs font-semibold sm:text-sm text-slate-800">
              {formatDate(lastCycle.consumptionStartDate)} -{' '}
              {formatDate(lastCycle.consumptionEndDate)}
            </div>
          </div>
